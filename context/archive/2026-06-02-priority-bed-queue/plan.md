...
- [x] 5.1 `npx astro sync` succeeds. — 5b8c94d
- [x] 5.2 `npm run lint` succeeds. — 5b8c94d
- [x] 5.3 `npm run build` succeeds. — 5b8c94d
- [x] 5.4 `context/changes/priority-bed-queue/plan.md` and `plan-brief.md` both exist. — 5b8c94d

#### Manual

- [x] 5.5 Anonymous `/garden` request redirects to `/auth/signin`. — 5b8c94d
- [x] 5.6 Logged-in user A can add low, medium, and high weed-level beds and see them sorted by priority. — 5b8c94d
- [x] 5.7 Suggested dates follow the fixed interval table for each weed level. — 5b8c94d
- [x] 5.8 A bed with missing optional inputs remains visible with degraded confidence. — 5b8c94d
- [x] 5.9 Logged-in user B does not see user A's beds. — 5b8c94d
- [x] 5.10 Reviewer confirms no S-02 plant list, S-03 weed observations, S-04 weeding-history, or update/delete scope slipped into S-01. — 5b8c94d
